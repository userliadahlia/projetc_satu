...
<h4><b>Edit Data Katalog Model</b></h1>
<br>
...
<div class="mb-3 row">
    <label for="penerbit" class="col-sm-2 col-form-label">Pengarang</label>
    <div class="col-sm-10">
    <input type="text" class="form-control" id="penerbit" value="{{$katalog->penerbit}}" name="penerbit">
    </div>
</div>
<div class="mb-3 row">
    <label for="pengarang" class="col-sm-2 col-form-label">Penerbit</label>
    <div class="col-sm-10">
